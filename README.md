...
1. You should be sure to [remove your docker images]() when you're at the stage you want to build the docker image using gradle, so you'don't accidentally confuse yourself by using your maven-produced image.
